...
public class PatientSaLevelActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		TextView staffName = (TextView) this.findViewById(R.id.staff_name_label_patient_sa02);
		TextView patientName = (TextView) this.findViewById(R.id.patient_name_label_patient_sa02);
