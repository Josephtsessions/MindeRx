...
/**
 * An example full-screen abstract activity that enables the showing and hiding of 
 * the system UI (i.e. status bar and navigation/system bar) with user interaction.
 * 
 * @see SystemUiHider
 */
abstract class VitalsActivity  extends Activity  {
	/**
